...
type Header struct {
	...
	InspectionTypeConfirmedValueInText       *string  `json:"InspectionTypeConfirmedValueInText"`
	InspectionTypeConfirmedValueInQuantity   *float32 `json:"InspectionTypeConfirmedValueInQuantity"`
	InspectionResult                         *bool    `json:"InspectionResult"`
